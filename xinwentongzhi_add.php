...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#366ec9" style="border-collapse:collapse">    
	<tr><td>title：</td><td><input name='biaoti' type='text' id='biaoti' value='' size='50'  />&nbsp;*</td></tr><tr><td>category：</td><td><input name='leibie' type='text' id='leibie' value='<?php echo $lb;?>' />&nbsp;*</td></tr><tr><td>content：</td><td><textarea name="neirong" style="width:700px;height:200px;visibility:hidden;"></textarea></td></tr><tr><td>index picture：</td><td><input name='shouyetupian' type='text' id='shouyetupian' value='' size='50'  />&nbsp;<a href="javaScript:OpenScript('upfile.php?Result=shouyetupian',460,180)"><img src="Images/Upload.gif" width="30" height="16" border="0" align="absmiddle" /></a></td></tr><tr><td>click rate：</td><td><input name='dianjilv' type='text' id='dianjilv' value='1' /></td></tr><tr>
	  <td>Publisher</td>
